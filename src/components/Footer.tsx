const Footer = () => {
    return (
        <section className="flex mt-6 flex-col h-screen lg:justify-end font-poppins">
                ...
                <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-0">
                    <div className="flex items-center justify-center pb-3 border-b border-gray-300 dark:border-gray-700 lg:justify-between">
                        ...
                        <div className="flex justify-center ">
                            ...
                            <a href="#" className="mr-6 text-gray-600 dark:text-gray-400 hover:text-blue-400">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                                    height="16"
                            ...
                            <a href="#" className="mr-6 text-gray-600 dark:text-gray-400 hover:text-red-600">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                                    height="16"
                            ...
                            <a href="#" className="mr-6 text-gray-600 dark:text-gray-400 hover:text-blue-600">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                                    height="16"
                    ...
                    <div className="flex flex-wrap py-10 -mx-3">
                        <div className="w-full px-4 mb-11 md:w-1/2 lg:w-4/12 lg:mb-0">
                            <a href="#" className="inline-block mb-4 text-2xl font-bold dark:text-gray-400">
                                Logo
                            </a>
                            <p className="text-base font-normal leading-6 lg:w-64 dark:text-gray-400">
                                Lorem ipsum dor amet Lorem ipsum dor amet Lorem ipsum dor Lorem ipsum dor amet Lorem
                                ipsum dor amet Lorem ipsum dor
                            </p>
                        </div>
                        <div className="w-full px-4 md:w-1/4 lg:w-2/12 mb-11 lg:mb-0">
                            ...
                            <ul>
                                <li className="mb-4">
                                    <a href="#" className="inline-block text-base font-normal dark:text-gray-400">
                                        Home
                                    </a>
                                </li>
                                <li className="mb-4">
                        ...
                        <div className="w-full px-4 mb-2 lg:mb-0 md:w-1/3 lg:w-4/12">
                            <h2 className="mb-4 text-lg font-bold text-gray-800 dark:text-gray-400">Newsletter</h2>
